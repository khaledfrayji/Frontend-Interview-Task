...
const Navbar = () => {
  ...
  // To toggle the dropdown when hovered
    ...
    <header className="w-full">
      ...
      <nav className="bg-white flex justify-between items-center py-4 px-4 md:px-12 shadow-md relative">
        ...
        <div className="flex items-center px-4">
          <img src="/alpha.png" alt="Logo" width={250} height={250} />
        </div>

        {/* Links for larger screens */}
        <ul className="hidden md:flex items-center space-x-6 text-gray-800 font-bold">
          <li className="flex items-center hover:bg-[#2A2C38] hover:text-white p-5">
          ...
          {/* Services dropdown */}
          <li
            className="relative z-10 flex items-center p-5 hover:bg-[#2A2C38] hover:text-white"
          ...
          >
            ...
            {/* Dropdown menu */}
            <div
              className={`absolute top-full left-0 mt-2 w-72 bg-white shadow-lg rounded-md transition-all duration-300 ease-in-out ${
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-md z-20 flex justify-center items-center">
          <div className="bg-white p-6 rounded-md w-10/12 max-w-sm text-center">
