...
const AboutComponent = () => {
  return (
    <div className="w-full mx-auto py-12 px-4 md:px-8 bg-[#f2f2f2]">
        <h1 className="font-bold text-[3rem] text-gray-800 ml-10 pb-20">About Us</h1>
      <div className="text-center mb-8">
        <FaRegSmile className="text-orange-500 mx-auto" size={40} />
        <h2 className="text-4xl font-bold mt-2">We Believe You're Bright</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* Our Story Section */}
          <div>
            <h3 className="text-2xl pt-20 font-semibold text-black">
